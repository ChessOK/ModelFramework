...
{
    /// <summary>
    /// –еализует интерфейс <see cref="IApplicationBus"/>. 
    /// </summary>
    /// 
    /// <remarks>
    /// —писок обработчиков
    ...
    /// 
    /// ƒл€ обработчиков типа <see cref="ApplicationBusMessageHandler"/> автоматически
    /// предоставл€ет свой экземпл€р <see cref="ApplicationBus"/> при инициализации.
    /// 
    /// —оздает дочерний <see cref="IModelContext"/>, предоставл€ющий
    /// <see cref="ILifetimeScope"/> с тегом <see cref="ContextHierarchy.ApplicationBus"/>.
    /// 
    /// —оздает и управл€ет <see cref="ValidationContext"/>, который €вл€етс€
    /// общим дл€ экземпл€ра <see cref="ApplicationBus"/> и всех сообщений <see cref="IApplicationBusMessage"/>.
    /// </remarks>
